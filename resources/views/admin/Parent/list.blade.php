                                    ...
                                    <div class="card-body row">
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control" id="name"
                                                placeholder="Search for name" name="first_name"
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control" id="last_name"
                                                placeholder="Search for last name" name="last_name"
                                                value="{{ old('last_name') }}" />
                                        </div>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control" id="email"
                                                placeholder="Search for email" name="email" value="{{ old('email') }}" />
                                        </div>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control" id="occupation"
                                                placeholder="Search for occupation" name="occupation"
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control" id="address"
                                                placeholder="Search for address" name="address"
                                                value="{{ old('address') }}" />
                                        </div>
